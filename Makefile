...
DEBUG_FLAGS = -ggdb
DEBUG_FLAGS_EXTRA = -fsanitize=memory
...
CFLAGS+=-DELECTRON_STEADY_STATE=0
CFLAGS+=-DPOSITRON_STEADY_STATE=0
CFLAGS+=-DLEPTON_STEADY_STATE=0
CFLAGS+=-DPROTON_STEADY_STATE=0
...
SOURCES = \
	./src/acceleration.c 					\
	./src/bethe_heitler.c 					\
	./src/bethe_heitler_kelner_aharonian.c	\
	./src/config.c		 					\
	./src/distribution.c 					\
	./src/escape.c							\
...
OBJECTS = \
	./src/acceleration.o 					\
	./src/bethe_heitler.o 					\
	./src/bethe_heitler_kelner_aharonian.o	\
	./src/config.o		 					\
	./src/distribution.o 					\
	./src/escape.o							\
...
HEADERS = \
	./src/acceleration.h 					\
	./src/bethe_heitler.h 					\
	./src/bethe_heitler_kelner_aharonian.h 	\
	./src/config.h		 					\
	./src/constants.h						\
	./src/distribution.h					\
	./src/escape.h							\
