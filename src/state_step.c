...
static void step_calculate_processes(state_t *st)
{
#if USE_THREADS
...
static void step_update_populations(state_t *st, double dt)
{
    unsigned int i;
...
static void step_experimental_update_populations(state_t *st, double dt)
{
    unsigned int i;
    double g_turnover;
    double dlng;
 ...
 */
static bool step_check_tentative_populations(state_t *st)
{
    unsigned int i;
#ifndef NDEBUG
...
static void step_fix_tentative_zeros(state_t *st)
{
    unsigned int i;
